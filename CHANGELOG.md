...
### Changed
- Panther desktop installs now include the graphical Guix frontend (guix-gui).
...
### Fixed
- Wi-Fi no longer drops mid-install: the provisioning file now persists for the session instead of being deleted.
